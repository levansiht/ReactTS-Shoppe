...
export default function ProductDetail() {
  ...
  const buyNow = async () => {
    const res = await addToCartMutation.mutateAsync({ buy_count: buyCount, product_id: product?.id as string })
            ...
            <div className='grid grid-cols-12 gap-9'>
              ...
              <div className='col-span-7'>
                ...
                <div className='mt-8 flex items-center'>
                  ...
                  <button
                    onClick={buyNow}
                    className='hover:bg-orange/90 ml-4 flex h-12 min-w-[5rem] items-center justify-center rounded-sm bg-orange px-5 capitalize text-white shadow-sm outline-none'
                  >
                    Mua ngay
                  </button>
                </div>
