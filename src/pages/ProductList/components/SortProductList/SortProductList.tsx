          ...
          <div className='ml-2 flex'>
            {page === 1 ? (
              ...
              <Link
                ...
                className='flex w-9 justify-center items-center h-8 rounded-tl-sm rounded-bl-sm bg-white hover:bg-slate-100 cursor-not-allowed shadow'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
            ...
            {page === pageSize ? (
              <span className='flex w-9 justify-center items-center h-8 rounded-tl-sm rounded-bl-sm bg-white/60 hover:bg-slate-100  shadow'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
                  viewBox='0 0 24 24'
